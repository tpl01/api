...
public class PojoDTO implements Serializable {
	...
	public PojoDTO(int id, String firstName, String lastName, String middleInitial, String email, String mobilePhoneNumber, String phoneNumber, String zipCode, String address, String city, String ssn, String createDate, boolean zelleEnrolled, CountryDTO country, String state, UserDTO user, List<Object> accounts) {
		this.id = id;
